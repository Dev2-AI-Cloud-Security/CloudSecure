...
output "instance_ip" {
  description = "Public IP of the existing cloudsecure instance"
  value       = data.aws_instance.cloudsecure.public_ip
}

output "instance_public_dns" {
  description = "Public DNS of the existing cloudsecure instance"
  value       = data.aws_instance.cloudsecure.public_dns
}